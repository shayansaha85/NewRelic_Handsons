...
export default class Nr1HowtoAddTimePicker extends React.Component {
    ...
    render() {
        ...
        const trxOverview = `SELECT uniques(incidentLink) FROM NrAiIncident WHERE entity.name LIKE '210135-Partner Ready Portal (PRP)-Production' LIMIT 10`;
